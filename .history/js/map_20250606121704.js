// Function called by Google Maps API when the script is loaded
function initMap() {
  // Create the map
  const map = new google.maps.Map(document.getElementById("map"), {
    center: { lat: 43.8206, lng: -111.7830 }, // Example: Rexburg, Idaho
    zoom: 13,
    mapTypeId: "roadmap", // You can change this to "satellite", "terrain", etc.
  });

  // Example marker data (you’ll replace with your real locations)
  const locations = [
